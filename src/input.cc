...
void do_input(input *input, HWND hwnd, s32 ms_scroll)
{
    // mouse cursor
    POINT mouse_point;
    ...
    input->mouse.pos.x      = mouse_point.x;
    input->mouse.pos.y      = mouse_point.y;
    ...
    // keyboard
    process_keyboard_message(input->keyboard.a, ::GetKeyState(keys::a) & (1 << 15));
    process_keyboard_message(input->keyboard.b, ::GetKeyState(keys::b) & (1 << 15));
    process_keyboard_message(input->keyboard.c, ::GetKeyState(keys::c) & (1 << 15));
    process_keyboard_message(input->keyboard.d, ::GetKeyState(keys::d) & (1 << 15));
    process_keyboard_message(input->keyboard.e, ::GetKeyState(keys::e) & (1 << 15));
    process_keyboard_message(input->keyboard.f, ::GetKeyState(keys::f) & (1 << 15));
    process_keyboard_message(input->keyboard.g, ::GetKeyState(keys::g) & (1 << 15));
    process_keyboard_message(input->keyboard.i, ::GetKeyState(keys::i) & (1 << 15));
    process_keyboard_message(input->keyboard.j, ::GetKeyState(keys::j) & (1 << 15));
    process_keyboard_message(input->keyboard.k, ::GetKeyState(keys::k) & (1 << 15));
    process_keyboard_message(input->keyboard.l, ::GetKeyState(keys::l) & (1 << 15));
    process_keyboard_message(input->keyboard.m, ::GetKeyState(keys::m) & (1 << 15));
    process_keyboard_message(input->keyboard.n, ::GetKeyState(keys::n) & (1 << 15));
    process_keyboard_message(input->keyboard.o, ::GetKeyState(keys::o) & (1 << 15));
    process_keyboard_message(input->keyboard.p, ::GetKeyState(keys::p) & (1 << 15));
    process_keyboard_message(input->keyboard.q, ::GetKeyState(keys::q) & (1 << 15));
    process_keyboard_message(input->keyboard.r, ::GetKeyState(keys::r) & (1 << 15));
    process_keyboard_message(input->keyboard.s, ::GetKeyState(keys::s) & (1 << 15));
    process_keyboard_message(input->keyboard.t, ::GetKeyState(keys::t) & (1 << 15));
    process_keyboard_message(input->keyboard.u, ::GetKeyState(keys::u) & (1 << 15));
    process_keyboard_message(input->keyboard.v, ::GetKeyState(keys::v) & (1 << 15));
    process_keyboard_message(input->keyboard.w, ::GetKeyState(keys::w) & (1 << 15));
    process_keyboard_message(input->keyboard.x, ::GetKeyState(keys::x) & (1 << 15));
    process_keyboard_message(input->keyboard.y, ::GetKeyState(keys::y) & (1 << 15));
    process_keyboard_message(input->keyboard.z, ::GetKeyState(keys::z) & (1 << 15));
    process_keyboard_message(input->keyboard.d1, ::GetKeyState(keys::d1) & (1 << 15));
    process_keyboard_message(input->keyboard.d2, ::GetKeyState(keys::d2) & (1 << 15));
    process_keyboard_message(input->keyboard.d3, ::GetKeyState(keys::d3) & (1 << 15));
    process_keyboard_message(input->keyboard.d4, ::GetKeyState(keys::d4) & (1 << 15));
    process_keyboard_message(input->keyboard.d5, ::GetKeyState(keys::d5) & (1 << 15));
    process_keyboard_message(input->keyboard.d6, ::GetKeyState(keys::d6) & (1 << 15));
    process_keyboard_message(input->keyboard.d7, ::GetKeyState(keys::d7) & (1 << 15));
    process_keyboard_message(input->keyboard.d8, ::GetKeyState(keys::d8) & (1 << 15));
    process_keyboard_message(input->keyboard.d9, ::GetKeyState(keys::d9) & (1 << 15));
    process_keyboard_message(input->keyboard.d0, ::GetKeyState(keys::d0) & (1 << 15));
    process_keyboard_message(input->keyboard.tab, ::GetKeyState(keys::tab) & (1 << 15));
    process_keyboard_message(input->keyboard.enter, ::GetKeyState(keys::enter) & (1 << 15));
    process_keyboard_message(input->keyboard.space, ::GetKeyState(keys::space) & (1 << 15));
    process_keyboard_message(input->keyboard.left_shift,
